...
function insertOne(){
    document.getElementById('post-button').addEventListener('click', function(event){
	  ...
	  var salesorderID = document.getElementById('salesorderID-input').value;
	  var customerID = document.getElementById('customerID-input').value;
	  var POnumber = document.getElementById('POnumber-input').value;	
	  var status = document.getElementById('email-input').value;
